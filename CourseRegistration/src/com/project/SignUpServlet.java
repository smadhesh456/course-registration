...
public class SignUpServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            System.err.println("===========================================");
            logger.log(Level.SEVERE, "Registration error for: " + username, e);
            try {
                res.sendRedirect("signup.jsp?error=Error: " + e.getClass().getSimpleName() + " - " + e.getMessage());
            } catch (Exception ex) {
                System.err.println("Error sending redirect: " + ex.getMessage());
            }
        }
    }
}